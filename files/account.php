...
<body>
	<header id="header"><!--header-->
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							...
							{
							echo "<li><a href='login.html'><i class='fa fa-user'></i>Account</a></li>";
		...
		while($row = mysql_fetch_array($result)) 
		{
         ...
         //echo "<br>";		
         ?>
		 <div class="alert alert-success" role="alert"><strong>NAME:</strong><?php echo $row['FirstName'] . " " . $row['LastName']?></div>
         <div class="alert alert-info" role="alert"><strong>E-MAIL:</strong><?php echo $row['Email']?></div>
         <div class="alert alert-warning" role="alert"><strong>User-Id:</strong><?php echo $row['UserId']?></div>
         <div class="alert alert-danger" role="alert" ><strong>Password:</strong><?php echo $row['Password']?></div>
		 <?php } ?>
	</header><!--/header-->
