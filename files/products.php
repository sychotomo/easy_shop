...
$added=$_GET["added"];
if($added==1)
echo "<div class='alert alert-warning alert-dismissible' role='alert'><button type='button' class='close' data-dismiss='alert'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button><center><strong>DONE!</strong>Product Added to Wishlist.</center></div>";
}
?>
<body>
							...
							<div class="product-image-wrapper">
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<a class="btn btn-default"  type="button" href="addwishlist.php?id=<?php echo $id?> & location=products" <?php if(empty($_SESSION['login_user'])) echo "disabled"; ?> 	</span><p style="color:orange"> <span class="glyphicon glyphicon-star"></span>ADD TO WISH LIST</p></a>
										</div>
										</ul>
									</div>
							</div>
