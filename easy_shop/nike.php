...
<body>
	...
	<section>
	  ...
	  $sql="SELECT  product,id,brand,type,price,image_name FROM items WHERE brand= '$name' OR product='$name' OR type='$name'";
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<h2 style="color:orange"><?php echo $brand." ".$type; ?></h2>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2 style="color:orange"><?php echo $brand." ".$type; ?></h2>
												<p style="color:green">Rs.<?php echo $price?></p>
