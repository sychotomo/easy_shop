					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									<span>Rs.<?php echo $row[5]?></span>
									<label>Quantity:</label>
									<input type="text" value="1"/>
									
									<a href="<?php echo "cart.php?action=add&id=$id";?>" class="btn btn-fefault cart"><i class="fa fa-shopping-cart"></i>Add to cart</a><br>
								</span>
								<p><b>Availability:</b> In Stock</p>
								<p><b>Condition:</b> New</p>
								<p><b>Brand:</b> <?php echo $brand?></p>
								<a href="https://www.facebook.com/"><img src="images/product-details/share.png" class="share img-responsive"  alt="" /></a>
